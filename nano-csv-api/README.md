...
https://2wxa6g-ip-103-151-172-36.tunnelmole.net

The buyer's real payment acceptance test is still pending. This is a temporary
public hostname for pilot testing; it may change after a connection restart. Simulated test payments are not
income. No availability SLA is offered for the pilot.
...
GET `/v1/credit` with that token refreshes confirmed deposits and returns credit
and usage. Confirmed incoming amounts, consumed usage and unused prepayment are
recorded separately.
